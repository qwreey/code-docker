...
// document intact; callers are responsible for triggering a
// tailscale-forward supervisord restart afterward so the change takes
// effect (this package does not know about supervisord).
package tailscale
...
// drops comments in the original file — an accepted tradeoff once webmanager
// owns this file.
